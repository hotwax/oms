-- SQL queries to delete poll_SystemMessageFileSftp_NewProductsFeed service job and related data

delete from service_job_run where job_name = 'poll_SystemMessageFileSftp_NewProductsFeed'
delete from service_job_run_lock where job_name = 'poll_SystemMessageFileSftp_NewProductsFeed'
...
-- SQL queries to delete poll_SystemMessageFileSftp_ProductUpdatesFeed service job and related data

delete from service_job_run where job_name = 'poll_SystemMessageFileSftp_ProductUpdatesFeed'
delete from service_job_run_lock where job_name = 'poll_SystemMessageFileSftp_ProductUpdatesFeed'
